// Modified by the Bot project on 2026-09-15: stamp the executable with its release version.
use std::path::Path;
...
fn main() {
    println!("cargo:rerun-if-env-changed=BOT_VERSION");
    ...
    let version = std::env::var("BOT_VERSION")
