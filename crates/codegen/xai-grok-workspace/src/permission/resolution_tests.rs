// Modified by the Bot project on 2026-09-15: isolate global Claude fixture discovery.
use super::*;
...
fn untrusted_project_claude_permissions_are_not_honored() {
    ...
    let _claude_guard = EnvVarGuard::set("XAI_WORKSPACE_TEST_CLAUDE_HOME", home.path());
    let _marker_guard = EnvVarGuard::unset("_GROK_CLAUDE_MARKER_OVERRIDE");
