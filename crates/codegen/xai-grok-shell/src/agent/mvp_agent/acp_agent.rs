// Modified by the Bot project on 2026-09-12: remove the private privacy endpoint.
...
impl acp::Agent for MvpAgent {
    ...
    async fn ext_method(
        ...
        let result = match method.as_ref() {
            ...
            "x.ai/btw" => crate::extensions::btw::handle_btw(self, &args).await,
            ...
            s if s.starts_with("x.ai/review") => {
                crate::extensions::review::handle_review(self, &args).await
            }
