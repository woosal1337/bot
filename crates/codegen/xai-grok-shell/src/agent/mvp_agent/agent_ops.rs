...
impl MvpAgent {
    ...
    /// Publish model-owned credentials for tool static fallthrough.
    ...
    /// The leader then sees the agent's live view of running turns and subagents and can flush sessions at shutdown.
    ...
    /// Mirrors the leader relaunch flush path ([`crate::agent::activity::AgentActivity::flush_all_sessions`]).
