...
use xai_grok_hooks::event::StopCancelledReason as Reason;
...
#[test]
fn the_turn_end_drain_budget_fits_the_session_grace_period() {
    assert!(2 * TURN_END_DRAIN_BUDGET < crate::agent::activity::SESSION_FLUSH_GRACE);
}
