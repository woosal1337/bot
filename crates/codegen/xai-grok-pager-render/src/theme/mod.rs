// Modified by the Bot project on 2026-09-13: use Bot theme display names.
...
/// Human-friendly display name for a canonical theme value (e.g. `"groknight"` becomes `"Bot Night"`).
