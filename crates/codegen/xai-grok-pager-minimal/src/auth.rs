// Modified by the Bot project on 2026-09-15: keep authentication tests aligned with the public flow.
...
mod tests {
    ...
    fn auth_hint_maps_pending_trust_after_auth() {
        ...
        // The ZDR gate suppresses the trust question (matches welcome and the input interceptor)
        assert!(matches!(
