#!/usr/bin/env node
// Modified by the Bot project on 2026-09-13: Verify installer metadata stays out of user config.
...
if (process.platform !== 'win32') {
    ...
    test('mirrored link matches postinstall.js and the shipped entry wires the bootstrap', () => {
        ...
        for (const retired of ['obj.cli.installer', 'obj.cli.npm_registry']) {
            assert.ok(!postinstall.includes(retired), `postinstall.js retained updater metadata: ${retired}`);
        }
