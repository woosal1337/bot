// Modified by the Bot project on 2026-09-13: Removed provider-specific promotion shortcuts.
...
/// Ctrl+O opens the transcript unless an interject would consume the press.
...
pub fn compact_logo_visual_width() -> u16 {
    crate::views::welcome::logo::compact_logo_visual_width()
}
