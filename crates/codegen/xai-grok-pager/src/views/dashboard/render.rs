...
/// stays usable. Examples: `✗ Session no longer exists`, `✓ Theme: Bot Day`. The badge therefore
...
fn paint_dispatch_config_badge(
    ...
    match state.pending_mode {
        ...
        DashboardDispatchMode::AlwaysApprove => flags.push(PromptFlag {
            text: crate::provider::active_permission_keyword("always-approve"),
            color: None,
            bold: false,
        }),
...
fn multiline_submit_key() -> crate::input::key::KeyShortcut {
