// Modified by the Bot project on 2026-09-11: support provider-owned startup resumes.
...
pub fn materialize_provider_startup(
    ...
    match intent {
        ...
        SessionStartupIntent::Resume {
            ...
            anyhow::bail!("Provider resume requires a session ID. Open Bot and use /resume.")
        }
        SessionStartupIntent::ForkFrom { .. } => {
            anyhow::bail!("This provider does not support session forks.")
        }
    }
}
...
mod tests {
    ...
    #[test]
    fn provider_startup_resumes_without_local_session_resolution() {
        let materialized = materialize_provider_startup(SessionStartupIntent::Resume {
            session_id: Some("provider-thread".to_owned()),
            most_recent_for_cwd: false,
        })
