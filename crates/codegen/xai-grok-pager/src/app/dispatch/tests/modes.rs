// Modified by the Bot project on 2026-09-12: check pending and confirmed mode feedback.
...
// Mirrors the permission-mode test patterns.
...
/// State stays unchanged on an idempotent update.
#[test]
fn set_plan_mode_idempotent_on() {
    ...
    assert!(
        toast.contains("Changing plan mode"),
...
/// State stays unchanged on the opposite idempotent update.
#[test]
...
fn plan_mode_toast_format() {
    ...
    dispatch(
        Action::TaskComplete(TaskResult::SessionModeSet {
            session_id,
            mode_id: acp::SessionModeId::new("default"),
            result: Ok(()),
            unsent_prompt: None,
        }),
        &mut app,
