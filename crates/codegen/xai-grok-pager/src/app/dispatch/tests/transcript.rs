...
#[test]
fn successful_skill_toggle_refreshes_the_command_catalog() {
    ...
    let effects = dispatch(
        Action::TaskComplete(TaskResult::SkillsToggleDone {
            agent_id: id,
            result: Ok(vec![SkillInfo {
                name: "repo-skill".to_string(),
                path: "/work/.agents/skills/repo-skill/SKILL.md".to_string(),
                enabled: true,
                ..SkillInfo::default()
            }]),
        }),
