// Modified by the Bot project on 2026-09-12: remove provider-owned settings fixtures.
...
use super::modes::{
    active_agent_plan_nudge_state, dispatch_cycle_mode_and_sync, downgrade_displayed_auto_if_gated,
    permission_mode_toast, yolo_on_under_plan_toast,
};
...
fn make_ask_user_question_args(
    ...
    let req = AskUserQuestionExtRequest {
        ...
        question_metadata: Default::default(),
