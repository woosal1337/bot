// Modified by the Bot project on 2026-09-12: remove the inherited updater setting.
...
/// Effective-default lookup for the `Option<bool>` AppView mirrors (`show_tips`, ask_user_question timeout).
