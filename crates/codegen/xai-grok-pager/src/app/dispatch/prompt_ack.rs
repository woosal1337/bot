// Modified by the Bot project on 2026-09-13: provider-neutral recovery guidance.
...
fn prompt_ack_timeout_notice(limit: Duration, disposition: PromptAckDisposition) -> String {
    ...
    format!(
        "The agent did not accept your prompt within {limit_secs}s. {recovery} If this keeps happening, run /doctor."
    )
}
