// Modified by the Bot project on 2026-09-12: remove privacy banner links.
...
mod link_click_tests {
    ...
    fn draw_frame(agent: &mut AgentView, registry: &ActionRegistry) {
