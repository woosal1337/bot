// Modified by the Bot project on 2026-09-12: remove privacy banner state.
...
/// Banner-slot inputs to [`AgentView::draw`].
...
pub struct AgentView {
    ...
    /// Unlike `toast`, survives typing; cleared by TTL, any prompt-box submit, or explicit clear.
