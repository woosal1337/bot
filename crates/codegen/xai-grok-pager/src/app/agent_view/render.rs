// Modified by the Bot project on 2026-09-12: remove privacy banner rendering.
...
use super::{
    ...
    dropdown_content_inset, dropdown_items_width, render_dropdown_chrome, supports_osc22,
};
...
/// AppView-owned per-frame inputs to [`AgentView::draw`]: state the agent view cannot see itself.
    ...
    pub fn draw(
        ...
        let question_input_style = PromptStyle {
            ...
            mask_character: self
                .question_view
                .as_ref()
                .filter(|view| view.focus == crate::views::question_view::QuestionFocus::InputMode)
                .and_then(|view| view.active_question_is_secret().then_some('*')),
        };
