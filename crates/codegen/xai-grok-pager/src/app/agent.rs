// Modified by the Bot project on 2026-09-13: Removed xAI credit-limit state.
...
mod tests {
    ...
    fn permission_label_yolo_wins_over_auto() {
        ...
        assert_eq!(session.permission_label(), PermissionLabel::ReadOnly);
    }
    #[test]
