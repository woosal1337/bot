...
fn format_acp_error_rate_limit_surfaces_detail_or_fallback() {
    ...
    assert_eq!(format_acp_error(&free, false), RATE_LIMITED_USER_MESSAGE_OAUTH);
    assert_eq!(format_acp_error(&free, true), RATE_LIMITED_USER_MESSAGE_API_KEY);
...
#[test]
fn format_session_info_api_key_auth_reports_environment() {
    let info = make_session_info("auto", None, 1000, 10000);
