// Modified by the Bot project on 2026-09-14: use Bot status-line error identity.
...
impl std::fmt::Display for RunError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            // Bot's own bug rather than the script's, so it says whose it is.
            RunError::Json(e) => write!(f, "could not encode Bot's payload: {e}"),
