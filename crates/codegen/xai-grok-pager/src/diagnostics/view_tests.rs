// Modified by the Bot project on 2026-09-13: use Bot diagnostic commands.
use super::*;
    ...
    assert_eq!(
        ...
        [
            (
                ...
                "bot doctor fix terminal.tmux-clipboard",
            ),
            (
                crate::diagnostics::DCS_PASSTHROUGH_ID,
                "bot doctor fix terminal.dcs-passthrough",
            ),
            (
                crate::diagnostics::TMUX_EXTENDED_KEYS_ID,
                "bot doctor fix terminal.tmux-extended-keys",
            ),
        ]
    );
